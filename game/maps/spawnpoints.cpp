...
const SpawnPoint points[] = {
    ...
    SpawnPoint({88, 60}, SpawnPoint::Mine),
    SpawnPoint({92, 61}, SpawnPoint::Mine),
    SpawnPoint({93, 65}, SpawnPoint::Mine),
    SpawnPoint({90, 68}, SpawnPoint::Mine),
    ...
    SpawnPoint({201, 15}, SpawnPoint::Bomber),
    SpawnPoint({211, 20}, SpawnPoint::Bomber),
