...
const SpawnPoint points[] = {
    ...
    SpawnPoint({79, 66}, SpawnPoint::EnemyBarracks),
    SpawnPoint({94, 66}, SpawnPoint::EnemyBarracks),
    ...
    SpawnPoint({46, 2}, SpawnPoint::Blueprint),
    SpawnPoint({154, 81}, SpawnPoint::Blueprint),
    SpawnPoint({117, 42}, SpawnPoint::Blueprint),
    SpawnPoint({170, 91}, SpawnPoint::Blueprint),
    SpawnPoint({82, 30}, SpawnPoint::Blueprint),
